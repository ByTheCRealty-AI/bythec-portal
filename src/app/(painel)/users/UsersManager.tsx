  ...
  return (
    <Modal title="Add login" onClose={onClose}>
      <form action={submit} className="space-y-4">
        ...
        <Field label="Address">
          <input name="address" className={inputClass} placeholder="123 Main St, Hyannis, MA 02601" />
        </Field>
        ...
        <Field label="Phone">
          <input name="phone" type="tel" className={inputClass} placeholder="(508) 555-0142" />
        </Field>
        <Field label="Role">
